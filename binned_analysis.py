...
def generate_files(vars):
    ...
    make4FGLxml_command = [f'python make4FGLxml.py ./data/gll_psc_v32.xml --event_file ./data/LC_{time_interval_name}/{short_name}_{time_interval_name}_{i}.fits -o ./data/LC_{time_interval_name}/models/{short_name}_input_model_{i}.xml --free_radius 5.0 --norms_free_only True --sigma_to_free 25 --variable_free True']
